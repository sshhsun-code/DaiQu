...
import com.daiqu.cm.daiqu.widget.OnWheelChangedListener;
import com.daiqu.cm.daiqu.widget.OnWheelScrollListener;
import com.daiqu.cm.daiqu.widget.WheelView;
import com.daiqu.cm.daiqu.widget.adapters.AbstractWheelTextAdapter;
    ...
    public void setTextViewStyle(String curriteItemText, CalendarTextAdapter adapter) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (curriteItemText.equals(currentText)) {
                ...
                textvew.setTextColor(mContext.getResources().getColor(R.color.text_gray));
            } else {
                textvew.setTextSize(MIN_TEXT_SIZE);
                textvew.setTextColor(mContext.getResources().getColor(R.color.text_wgray));
            }
        }
    }
...
//                    dateChooseInterface.getDateTime(strTimeToDateFormat(mYearStr, mDateStr));
//                } else {
                    dateChooseInterface.getDateTime(strTimeToDateFormat(mHourStr , mMinuteStr));
